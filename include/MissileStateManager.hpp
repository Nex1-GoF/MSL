...
#define MASK_SEEKER_ON  (1 << 0)  // 0x01 (0000 0001)
#define MASK_TDD_ON     (1 << 1)  // 0x02 (0000 0010)
#define MASK_DL_ON      (1 << 2)  // 0x04 (0000 0100)

//유도탄 상태 구조체  
struct missile_state_t {
    Vec3 r_m{0,0,0};
    Vec3 u_m{0,0,0}; 
    double V_m = 1500.0;  //속력
...
public:
    ...
    void updateState(missile_state_t new_state, Vec3 new_a_f, Vec3 new_pip, double time_now, char f_status, uint8_t t_status);
