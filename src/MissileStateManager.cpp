...
void
MissileStateManager::updateState( missile_state_t new_state, Vec3 new_a_f, Vec3 new_pip, double time_now, char f_status, uint8_t t_status) {
    std::lock_guard<std::mutex> lock(mtx);
